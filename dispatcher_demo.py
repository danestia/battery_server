...
def run_test():
    ...
    #pi_ip = '100.96.91.49' #raspberrypi
    pi_ip = "127.0.0.1"

    dispatcher = PlantformMQTTDispatcher(broker_ip=pi_ip, topic="prototypes")

    print(f"Sending test payload to {pi_ip} on topic 'prototypes'...")
